...
<link rel="stylesheet" type="text/css" href="/tp2/Public/Admin/css/jquery.dialog.css" />
<link rel="stylesheet" href="/tp2/Public/Admin/css/index.css" />
...
<div id="container">
    ...
    <div id="bd">
    	<div class="wrap ue-clear">
            ...
            <div class="content">
            	<iframe src="<?php echo U('index/home');?>" id="iframe" width="100%" height="100%" frameborder="0"></iframe>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="/tp2/Public/Admin/js/core.js"></script>
<script type="text/javascript" src="/tp2/Public/Admin/js/jquery.dialog.js"></script>
<script type="text/javascript" src="/tp2/Public/Admin/js/index1.js"></script>
